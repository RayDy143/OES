...
--
-- Host: localhost
-- Generation Time: Aug 13, 2018 at 04:58 AM
...
(169, 'Tuesday', '07:05:00', '12:05:00', 141),
(170, 'Wednesday', '07:05:00', '12:05:00', 141),
(171, 'Thursday', '07:05:00', '12:05:00', 141),
(172, 'Friday', '07:05:00', '12:05:00', 141),
(173, 'Saturday', '07:05:00', '12:05:00', 141);
...
(29, 'r2342342asfdasdf', 'sdfasdf', 'sdafasf', 'dsafasdf', 'efadfsd@gdf.com', 'asdfasdfasdfsadf', '2018-08-10', '34243214', 1, 0),
(31, '234234234', 'Krischan', 'Ddfgsfdg', 'Solon', 'Krischan@gmail.com', 'afasfsafsdfsd sdfsadfasd', '2018-08-10', '9898543534', 1, 0);
...
(24, 23, 136, '2018-08-09 13:17:20', 0),
...
(47, 23, 141, '2018-08-10 07:20:48', 1);
...
(141, 'Nas Morning Libr', 'Morning', '2018-08-10 07:17:30', 0);
...
(31, 'ACT_BLDG.jpg', '2018-08-10 08:00:11'),
...
(183, 'alfeche492@gmail.com', 'jr09058456538', 'Verified', 4, 1, 0, 0, '2018-08-11 07:49:56'),
(185, 'andresgotera@gmail.com', '09058456538', 'Verified', 1, 2, 0, 0, '2018-08-11 07:57:26'),
(186, 'beverly@gmail.com', 'beverly@gmail.com', 'Unverified', 21, 2, 1, 0, '2018-08-11 07:57:57'),
(191, 'ewrqwsdaf@gmail.com', 'ewrqwsdaf@gmail.com', 'Unverified', 4, 1, 1, 1, '2018-08-11 08:41:59'),
(197, 'joel@yahoo.com', 'joel@yahoo.com', 'Unverified', 1, 2, 1, 0, '2018-08-11 11:10:51'),
(202, 'alfeche492@outlook.com', '123123123', 'Verified', 4, 1, 0, 0, '2018-08-11 11:23:40'),
(203, 'mavick@gmail.com', 'mavick@gmail.com', 'Unverified', 1, 1, 1, 0, '2018-08-12 01:16:38'),
(291, 'sdafsda@gmail.com', 'sdafsda@gmail.com', 'Unverified', 2, 2, 1, 0, '2018-08-12 08:39:56'),
(292, 'werweqweqrwqer@dsafa.com', 'werweqweqrwqer@dsafa.com', 'Unverified', 2, 2, 1, 0, '2018-08-12 08:39:56'),
(293, 'cxvzxzvccx@gmail.com', 'cxvzxzvccx@gmail.com', 'Unverified', 2, 2, 1, 0, '2018-08-12 08:39:56'),
(294, 'werqwerewq@gmail.com', 'werqwerewq@gmail.com', 'Unverified', 1, 2, 1, 0, '2018-08-12 08:41:09'),
(295, 'werqwerewq@gmail.coms', 'werqwerewq@gmail.coms', 'Unverified', 1, 2, 1, 0, '2018-08-12 08:51:14');
...
(37, 'Raymundo', 'Remiticado', 'Alfeche', 'Naga City Cebu', '1999-04-11', 'Male', '09058456538', 183),
(38, 'Andres', 'S', 'Gotera', 'Cebu City', '1963-05-11', 'Male', '0905932423423', 185),
(39, 'Justin', 'A', 'Bieber', 'United States of America', '1997-02-08', 'Male', '0923432423', 202);
...
(18, '5b6e95422a784', '2018-08-11 07:50:26', 'Active', 183),
(19, '5b6f17cadede2', '2018-08-11 17:07:22', 'Active', 202);
...
--
ALTER TABLE `dailyschedule`
  MODIFY `DailyScheduleID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=174;
...
--
ALTER TABLE `nas`
  MODIFY `NasID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;

--
-- AUTO_INCREMENT for table `nasschedule`
--
ALTER TABLE `nasschedule`
  MODIFY `NasScheduleID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=48;

--
-- AUTO_INCREMENT for table `nasuploadedpicture`
--
ALTER TABLE `nasuploadedpicture`
  MODIFY `NasUploadedPictureID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
...
--
ALTER TABLE `schedule`
  MODIFY `ScheduleID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=142;

--
-- AUTO_INCREMENT for table `uploadedpicture`
--
ALTER TABLE `uploadedpicture`
  MODIFY `UploadedPictureID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=39;

--
-- AUTO_INCREMENT for table `useraccount`
--
ALTER TABLE `useraccount`
  MODIFY `UserID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=296;

--
-- AUTO_INCREMENT for table `userinfo`
--
ALTER TABLE `userinfo`
  MODIFY `UserInfoID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=40;
...
--
ALTER TABLE `useruploadedpicture`
  MODIFY `UserUploadedPictureID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT for table `userverificationcode`
--
ALTER TABLE `userverificationcode`
  MODIFY `UserVerificationCodeID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
