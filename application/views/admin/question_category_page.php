                ...
                if(response.success){
                    ...
                    for (var i = 0; i < cat.length; i++) {
                        _tableContent+='<tr>'
                                           ...
                                           +'<td><div data-role="buttongroup" class="row"><button id="Edit'+cat[i].CategoryID+'" class="button edit small cell bg-darkBlue fg-white ml-1 mr-1 mif-info"></button><button id="Delete'+cat[i].CategoryID+'" class="button delete cell small bg-darkRed fg-white ml-1 mr-1 mif-bin"></button></div></td>'
                                       +'</tr>';
                    }
