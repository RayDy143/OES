<div class="cell bg-white p-3 ml-4" style="overflow:auto;">
    ...
    <div class="row">
        ...
        <div class="stub ml-auto">
            <a href="<?php echo base_url('index.php/UserAccounts/View') ?>" type="button" class="button bg-darkBlue fg-white">VIEW USER ACCOUNTS</a>
        </div>
    </div>
    <hr class="row thick bg-darkBlue drop-shadow">
    <div class="row">
        <div class="cell-lg-6 cell-md-6 cell-sm-12">
          <div class="mr-4 mt-2" data-role="panel" data-title-caption="Add new user" data-cls-title="bg-darkBlue fg-white">
              <form action="javascript:" data-interactive-check="true" data-role="validator" data-on-validate-form="submitAddUserForm">
                  <div class="row">
                      ...
                      <div class="cell-12 form-group" id="DepartmentContainer">
        ...
        <div class="cell-lg-6 cell-md-6 cell-sm-12">
          <div class="mr-4 mt-2" data-role="panel" data-title-caption="Import user from excel files" data-cls-title="bg-darkBlue fg-white">
              <form id="frmImport" action="javascript:" data-role="validator" data-on-validate-form="validateImport">
                  <label><strong>Note: Excel file has to be its standard format.</label><label class="row ml-1">(Download Sample:<strong><a href="#">sample.xlxs</a>)</strong></label>
                  <div class="row">
                      <div class="cell-12 form-group">
...
<script>
    $(document).ready(function(){
        ...
        $('#File').change(function (e) {
            ...
            // alert(tmppath);
            // importExcel({
            //     filename:tmppath+"/"+$("#File").get(0).files[0].name,
            //     success:function(response){
            //         var _excelData = response;
                                          ...
                                          if(_length>0){
                                              ...
                                              for (var i = 0; i < _length; i++) {
                                                 ...
                                                 if(_check=="Deleted"){
                                                    ...
                                                    _importerrors.push(_excelRow.Email);
                                                    _unimportedrows++;
                                                }
                                            }
                                              var _errorcontent='';
                                              for (var i = 0; i < _importerrors.length; i++) {
                                                  _errorcontent+=_importerrors[i]+' ';
                                              }
                                              var html_content ="<p>"+_importedrows+" rows successfully imported."+_unimportedrows+" rows failed.</p>";
